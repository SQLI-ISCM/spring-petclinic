...
class OwnerControllerTests {
	...
	private static final String OWNERS_PAGE_1_URL = "/owners?page=1";
	...
	private static final String TEL_6085551023 = "6085551023";
	...
	private Owner george() {
		...
		george.setTelephone(TEL_6085551023);
		Pet max = new Pet();
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc
			.perform(post(OWNERS_NEW_URL).param(FIRST_NAME, "Joe")
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc
			.perform(post(OWNERS_NEW_URL).param(FIRST_NAME, "Joe").param(LAST_NAME, BLOGGS).param("city", LONDON))
			.andExpect(status().isOk())
	...
	void testProcessFindFormSuccess() throws Exception {
		...
		mockMvc.perform(get(OWNERS_PAGE_1_URL)).andExpect(status().isOk()).andExpect(view().name("owners/ownersList"));
	}
	...
	void testProcessFindFormByLastName() throws Exception {
		...
		mockMvc.perform(get(OWNERS_PAGE_1_URL).param(LAST_NAME, FRANKLIN))
			.andExpect(status().is3xxRedirection())
	...
	void testProcessFindFormNoOwnersFound() throws Exception {
		...
		mockMvc.perform(get(OWNERS_PAGE_1_URL).param(LAST_NAME, "Unknown Surname"))
			.andExpect(status().isOk())
	...
	void testInitUpdateOwnerForm() throws Exception {
		mockMvc.perform(get(OWNER_EDIT_URL, TEST_OWNER_ID))
			...
			.andExpect(model().attribute(OWNER, hasProperty(TELEPHONE, is(TEL_6085551023))))
			.andExpect(view().name(OWNERS_CREATE_OR_UPDATE_OWNER_FORM));
	}
	...
	void testProcessUpdateOwnerFormSuccess() throws Exception {
		mockMvc
			.perform(post(OWNER_EDIT_URL, TEST_OWNER_ID).param(FIRST_NAME, "Joe")
				.param(LAST_NAME, BLOGGS)
				.param(ADDRESS, "123 Caramel Street")
				.param("city", LONDON)
	...
	public void testProcessUpdateOwnerFormWithIdMismatch() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post(OWNER_EDIT_URL, pathOwnerId).flashAttr(OWNER, owner))
			.andExpect(status().is3xxRedirection())
