...
class OwnerControllerTests {
	...
	private static final String PHONE_6085551023 = "6085551023";
	...
	private Owner george() {
		...
		george.setTelephone(PHONE_6085551023);
		Pet max = new Pet();
	...
	void testInitUpdateOwnerForm() throws Exception {
		mockMvc.perform(get(OWNER_EDIT_PATH, TEST_OWNER_ID))
			...
			.andExpect(model().attribute(OWNER, hasProperty(TELEPHONE, is(PHONE_6085551023))))
			.andExpect(view().name(CREATE_OR_UPDATE_OWNER_FORM));
	}
