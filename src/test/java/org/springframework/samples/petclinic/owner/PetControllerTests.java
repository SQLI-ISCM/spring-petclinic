...
class PetControllerTests {
	...
	private static final String CREATE_OR_UPDATE_FORM_VIEW = "pets/createOrUpdatePetForm";

	private static final String OWNER_MODEL = "owner";
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc
				.perform(post(NEW_PET_URL, TEST_OWNER_ID).param("name", PET_NAME)
						.param("type", HAMSTER)
						.param(BIRTH_DATE_PARAM, BIRTH_DATE_VALUE))
		...
		void testProcessCreationFormWithBlankName() throws Exception {
			mockMvc
					.perform(post(NEW_PET_URL, TEST_OWNER_ID).param("name", "\t \n")
						.param(BIRTH_DATE_PARAM, BIRTH_DATE_VALUE))
					.andExpect(model().attributeHasNoErrors(OWNER_MODEL))
	...
	void testProcessUpdateFormSuccess() throws Exception {
		mockMvc
				.perform(post(EDIT_PET_URL, TEST_OWNER_ID, TEST_PET_ID).param("name", PET_NAME)
						.param("type", HAMSTER)
						.param(BIRTH_DATE_PARAM, BIRTH_DATE_VALUE))
				.andExpect(status().is3xxRedirection())
				.andExpect(view().name("redirect:/owners/{ownerId}"));
