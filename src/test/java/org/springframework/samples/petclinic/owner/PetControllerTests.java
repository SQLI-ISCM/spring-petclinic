...
class PetControllerTests {
	...
	private static final String PETS_CREATE_OR_UPDATE_VIEW = "pets/createOrUpdatePetForm";
	...
	void testInitCreationForm() throws Exception {
		mockMvc.perform(get(NEW_PET_PATH, TEST_OWNER_ID))
			...
			.andExpect(view().name(PETS_CREATE_OR_UPDATE_VIEW))
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc
			.perform(post(NEW_PET_PATH, TEST_OWNER_ID).param("name", BETTY)
				.param("type", HAMSTER)
				.param(BIRTH_DATE_FIELD, BIRTH_DATE_STRING))
	...
	void testProcessUpdateFormSuccess() throws Exception {
		mockMvc
			.perform(post(EDIT_PET_PATH, TEST_OWNER_ID, TEST_PET_ID).param("name", BETTY)
				.param("type", HAMSTER)
				.param(BIRTH_DATE_FIELD, BIRTH_DATE_STRING))
			.andExpect(status().is3xxRedirection())
			.andExpect(view().name("redirect:/owners/{ownerId}"));
