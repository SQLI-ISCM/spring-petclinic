...
class ClinicServiceTests {
	...
	private static final String SCHULTZ_LASTNAME = "Schultz";
	...
	void shouldInsertOwner() {
		Page<Owner> ownersPage = this.owners.findByLastNameStartingWith(SCHULTZ_LASTNAME, pageable);
		int found = (int) ownersPage.getTotalElements();

		Owner owner = new Owner();
		owner.setFirstName("Sam");
		owner.setLastName(SCHULTZ_LASTNAME);
		...
		ownersPage = this.owners.findByLastNameStartingWith(SCHULTZ_LASTNAME, pageable);
