...
class ClinicServiceTests {
	...
	void shouldInsertOwner() {
		Page<Owner> ownersPage = this.owners.findByLastNameStartingWith(LAST_NAME_SCHULTZ, pageable);
		...
		ownersPage = this.owners.findByLastNameStartingWith(LAST_NAME_SCHULTZ, pageable);
