...
class CrashControllerIntegrationTests {
	...
	private static final String CRASH_PATH = "/oups";
	...
	void testTriggerExceptionJson() {
		ResponseEntity<Map<String, Object>> resp = rest.exchange(
				RequestEntity.get("http://localhost:" + port + CRASH_PATH).build(),
		...
		assertThat(resp.getBody()).containsEntry("path", CRASH_PATH);
	}
	...
	void testTriggerExceptionHtml() {
		...
		ResponseEntity<String> resp = rest.exchange("http://localhost:" + port + CRASH_PATH, HttpMethod.GET,
